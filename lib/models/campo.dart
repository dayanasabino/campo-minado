...
class Campo {
  ...
  // Função de adicionar vizinhos
  void adicionarVizinho(Campo vizinho) {
    final deltaLinha =
        (linha - vizinho.linha).abs(); // valor abs - absoluto sempre positivo
  ...
  void abrir() {
    ...
    if (vizinhancaSegura) {
      vizinhos.forEach((v) => v.abrir()); // gera uma recursividade
    }
  }
  ...
  // Cria um getter que retorna um boolean para saber se vizinhança é segura
